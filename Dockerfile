...
RUN  yum -y update && \
     yum -y install php gcc make curl httpd libaio php-gd php-pdo php-xml php-ldap php-odbc php-pear php-soap php-devel \
     php-xmlrpc curl-devel php-mysqlnd php-mbstring php-pecl-memcache postgresql-server postgresql-contrib && \
